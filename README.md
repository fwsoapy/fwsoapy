...
**[seedforge](https://github.com/fwsoapy/seedforge)** - Client-side Minecraft seed finder. Multi-criteria structure search with per-structure distance filters, proximity rules between structures, and biome targeting. Runs entirely in the browser via Cubiomes + WASM, no backend needed.
...
**[ranked-overlay](https://github.com/fwsoapy/ranked-overlay)** - Free live Fortnite ranked overlay and ELO tracker for OBS streamers. 8 designs, any accent color, real-time rank and season stats pulled from OliTracker.
